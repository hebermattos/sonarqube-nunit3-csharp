...
"c:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild" /p:DebugType=pdbonly bill.sln

"C:\Builds\7\Bill\CI - Bill\src\Bill\packages\opencover.4.6.519\OpenCover.Console.exe" -log:All -register:user -target:"C:\Builds\7\Bill\CI - Bill\src\Bill\packages\NUnit.ConsoleRunner.3.5.0\tools\nunit3-console.exe" -targetargs:"\"C:\Builds\7\Bill\CI - Bill\src\Bill\test\RedeHost.Bill.Domain.Test\bin\Debug\RedeHost.Bill.Domain.Test.dll" -filter:"+[RedeHost.Bill.Domain]*" -output:"C:\Builds\7\Bill\CI - Bill\src\Bill\OpenCoverResults.xml" 
